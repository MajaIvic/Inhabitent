...
function font_awesom() {
    wp_enqueue_style( 'red-starter-style', get_stylesheet_uri() );
}
add_action( 'wp_enqueue_scripts', 'font_awesom' );
...
function red_starter_scripts() {
	...
	wp_enqueue_style( 'fontawesom',"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.11.2/css/all.css");
